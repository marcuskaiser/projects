...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "independence_tests.hsic_cy",
        "sources": [
            "hsic_cy.pyx"
        ]
    },
    "module_name": "independence_tests.hsic_cy"
}
END: Cython Metadata */
...
#define __PYX_HAVE__independence_tests__hsic_cy
#define __PYX_HAVE_API__independence_tests__hsic_cy
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
/* "independence_tests/hsic_cy.pyx":9
 * 
 * DTYPE = np.float_
 ...
 * np.import_array()
 */
typedef __pyx_t_5numpy_double_t __pyx_t_18independence_tests_7hsic_cy_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
struct __pyx_opt_args_18independence_tests_7hsic_cy_hsic;

/* "independence_tests/hsic_cy.pyx":16
...
struct __pyx_opt_args_18independence_tests_7hsic_cy_hsic {
  int __pyx_n;
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t sigma_x;
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t sigma_y;
  int scale;
};
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t(PyObject *, int writable_flag);

/* MemviewDtypeToObject.proto */
static CYTHON_INLINE PyObject *__pyx_memview_get_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t(const char *itemp);
static CYTHON_INLINE int __pyx_memview_set_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t(const char *itemp, PyObject *obj);
...
/* Module declarations from 'independence_tests.hsic_cy' */
...
static PyObject *__pyx_f_18independence_tests_7hsic_cy_hsic(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch, struct __pyx_opt_args_18independence_tests_7hsic_cy_hsic *__pyx_optional_args); /*proto*/
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "independence_tests.hsic_cy"
extern int __pyx_module_is_main_independence_tests__hsic_cy;
int __pyx_module_is_main_independence_tests__hsic_cy = 0;

/* Implementation of 'independence_tests.hsic_cy' */
...
static const char __pyx_k_hsic_line_16[] = "hsic (line 16)";
...
static PyObject *__pyx_kp_u_hsic_line_16;
...
static PyObject *__pyx_pf_18independence_tests_7hsic_cy_hsic(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_sigma_x, __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_sigma_y, int __pyx_v_scale); /* proto */
...
static PyObject *__pyx_pw_18independence_tests_7hsic_cy_1hsic(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_18independence_tests_7hsic_cy_hsic(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_18independence_tests_7hsic_cy_hsic *__pyx_optional_args) {
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_sigma_x = ((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t)0.0);
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_sigma_y = ((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t)0.0);

  /* "independence_tests/hsic_cy.pyx":17
 * @cython.wraparound(False)
 * cpdef hsic(DTYPE_t[:] x, DTYPE_t[:] y, DTYPE_t sigma_x=0.0,
 *            DTYPE_t sigma_y=0.0, bint scale=False):             # <<<<<<<<<<<<<<
 *     """
 ...
 */
  ...
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_trace_xy;
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_trace_xx;
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_trace_yy;
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_kx_ij;
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_ky_ij;
  ...
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_t_9;
  ...
  /* "independence_tests/hsic_cy.pyx":33
 *     >>>     hsic_score = trace_xy / (k_x.shape[0] - 1) ** 2
 *     """
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":37
 *     cdef Py_ssize_t j
 * 
 *     if n == 0:             # <<<<<<<<<<<<<<
 *         return 1.0
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "independence_tests/hsic_cy.pyx":38
 * 
 *     if n == 0:
 *         return 1.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":40
 *         return 1.0
 * 
 *     if sigma_x == 0.0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "independence_tests/hsic_cy.pyx":41
 * 
 *     if sigma_x == 0.0:
 *         sigma_x = np.median(pdist(np.array(x).reshape(-1, 1),             # <<<<<<<<<<<<<<
 *                                   metric='sqeuclidean'))
 ...
 */
    ...
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_median); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_pdist); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_array); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __pyx_memoryview_fromslice(__pyx_v_x, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t, 0);; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_8 = NULL;
    ...
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_reshape); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    ...
    /* "independence_tests/hsic_cy.pyx":42
 *     if sigma_x == 0.0:
 *         sigma_x = np.median(pdist(np.array(x).reshape(-1, 1),
 *                                   metric='sqeuclidean'))             # <<<<<<<<<<<<<<
 *     if sigma_y == 0.0:
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_metric, __pyx_n_s_sqeuclidean) < 0) __PYX_ERR(0, 42, __pyx_L1_error)
 ...
 *     if sigma_y == 0.0:
 */
    __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_7, __pyx_t_5); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __pyx_t_9 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_9 == ((npy_double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":43
 *         sigma_x = np.median(pdist(np.array(x).reshape(-1, 1),
 *                                   metric='sqeuclidean'))
 *     if sigma_y == 0.0:             # <<<<<<<<<<<<<<
 *         sigma_y = np.median(pdist(np.array(y).reshape(-1, 1),
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "independence_tests/hsic_cy.pyx":44
 *                                   metric='sqeuclidean'))
 *     if sigma_y == 0.0:
 *         sigma_y = np.median(pdist(np.array(y).reshape(-1, 1),             # <<<<<<<<<<<<<<
 *                                   metric='sqeuclidean'))
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_median); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_pdist); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = __pyx_memoryview_fromslice(__pyx_v_y, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t, 0);; if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_8 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_reshape); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    /* "independence_tests/hsic_cy.pyx":45
 *     if sigma_y == 0.0:
 *         sigma_y = np.median(pdist(np.array(y).reshape(-1, 1),
 *                                   metric='sqeuclidean'))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_metric, __pyx_n_s_sqeuclidean) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
 ...
 * 
 */
    __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_9 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_9 == ((npy_double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":47
 *                                   metric='sqeuclidean'))
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=1] kx_mean_1 = np.zeros(n, dtype=DTYPE)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_DTYPE); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_7, __pyx_t_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_10 = ((PyArrayObject *)__pyx_t_5);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_kx_mean_1.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "independence_tests/hsic_cy.pyx":48
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=1] kx_mean_1 = np.zeros(n, dtype=DTYPE)
 *     cdef np.ndarray[DTYPE_t, ndim=1] ky_mean_1 = np.zeros(n, dtype=DTYPE)             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t trace_xy = 0.0
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_n); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_n_s_DTYPE); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_6) < 0) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_7, __pyx_t_5); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ky_mean_1.rcbuffer->pybuffer, (PyObject*)__pyx_t_11, &__Pyx_TypeInfo_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "independence_tests/hsic_cy.pyx":49
 *     cdef np.ndarray[DTYPE_t, ndim=1] kx_mean_1 = np.zeros(n, dtype=DTYPE)
 *     cdef np.ndarray[DTYPE_t, ndim=1] ky_mean_1 = np.zeros(n, dtype=DTYPE)
 *     cdef DTYPE_t trace_xy = 0.0             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t trace_xx = 0.0
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":50
 *     cdef np.ndarray[DTYPE_t, ndim=1] ky_mean_1 = np.zeros(n, dtype=DTYPE)
 *     cdef DTYPE_t trace_xy = 0.0
 *     cdef DTYPE_t trace_xx = 0.0             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t trace_yy = 0.0
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":51
 *     cdef DTYPE_t trace_xy = 0.0
 *     cdef DTYPE_t trace_xx = 0.0
 *     cdef DTYPE_t trace_yy = 0.0             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t kx_ij = 0.0
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":52
 *     cdef DTYPE_t trace_xx = 0.0
 *     cdef DTYPE_t trace_yy = 0.0
 *     cdef DTYPE_t kx_ij = 0.0             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t ky_ij = 0.0
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":53
 *     cdef DTYPE_t trace_yy = 0.0
 *     cdef DTYPE_t kx_ij = 0.0
 *     cdef DTYPE_t ky_ij = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":55
 *     cdef DTYPE_t ky_ij = 0.0
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         for j in range(n):
 ...
 */
  ...
  for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
    ...
    /* "independence_tests/hsic_cy.pyx":56
 * 
 *     for i in range(n):
 *         for j in range(n):             # <<<<<<<<<<<<<<
 *             kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "independence_tests/hsic_cy.pyx":57
 *     for i in range(n):
 *         for j in range(n):
 *             kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)             # <<<<<<<<<<<<<<
 *             ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 ...
 */
      ...
      __pyx_v_kx_ij = exp(((-0.5 * pow(((*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_18 * __pyx_v_x.strides[0]) ))) - (*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_19 * __pyx_v_x.strides[0]) )))), 2.0)) / __pyx_v_sigma_x));

      /* "independence_tests/hsic_cy.pyx":58
 *         for j in range(n):
 *             kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 *             ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)             # <<<<<<<<<<<<<<
 *             kx_mean_1[i] += kx_ij
 ...
 */
      ...
      __pyx_v_ky_ij = exp(((-0.5 * pow(((*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_20 * __pyx_v_y.strides[0]) ))) - (*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_21 * __pyx_v_y.strides[0]) )))), 2.0)) / __pyx_v_sigma_y));

      /* "independence_tests/hsic_cy.pyx":59
 *             kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 *             ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 *             kx_mean_1[i] += kx_ij             # <<<<<<<<<<<<<<
 *             ky_mean_1[i] += ky_ij
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_kx_mean_1.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_kx_mean_1.diminfo[0].strides) += __pyx_v_kx_ij;

      /* "independence_tests/hsic_cy.pyx":60
 *             ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 *             kx_mean_1[i] += kx_ij
 *             ky_mean_1[i] += ky_ij             # <<<<<<<<<<<<<<
 *         kx_mean_1[i] /= n
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_ky_mean_1.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_ky_mean_1.diminfo[0].strides) += __pyx_v_ky_ij;
    }

    /* "independence_tests/hsic_cy.pyx":61
 *             kx_mean_1[i] += kx_ij
 *             ky_mean_1[i] += ky_ij
 *         kx_mean_1[i] /= n             # <<<<<<<<<<<<<<
 *         ky_mean_1[i] /= n
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_kx_mean_1.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_kx_mean_1.diminfo[0].strides) /= __pyx_v_n;

    /* "independence_tests/hsic_cy.pyx":62
 *             ky_mean_1[i] += ky_ij
 *         kx_mean_1[i] /= n
 *         ky_mean_1[i] /= n             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_ky_mean_1.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_ky_mean_1.diminfo[0].strides) /= __pyx_v_n;
  }

  /* "independence_tests/hsic_cy.pyx":64
 *         ky_mean_1[i] /= n
 * 
 *     if not scale:             # <<<<<<<<<<<<<<
 *         for i in range(n):
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "independence_tests/hsic_cy.pyx":65
 * 
 *     if not scale:
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             for j in range(n):
 ...
 */
    ...
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      ...
      /* "independence_tests/hsic_cy.pyx":66
 *     if not scale:
 *         for i in range(n):
 *             for j in range(n):             # <<<<<<<<<<<<<<
 *                 kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 ...
 */
      ...
      for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
        ...
        /* "independence_tests/hsic_cy.pyx":67
 *         for i in range(n):
 *             for j in range(n):
 *                 kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)             # <<<<<<<<<<<<<<
 *                 ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 ...
 */
        ...
        __pyx_v_kx_ij = exp(((-0.5 * pow(((*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_26 * __pyx_v_x.strides[0]) ))) - (*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_27 * __pyx_v_x.strides[0]) )))), 2.0)) / __pyx_v_sigma_x));

        /* "independence_tests/hsic_cy.pyx":68
 *             for j in range(n):
 *                 kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 *                 ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)             # <<<<<<<<<<<<<<
 *                 trace_xy += (kx_ij - kx_mean_1[i]) * (ky_ij - ky_mean_1[j])
 ...
 */
        ...
        __pyx_v_ky_ij = exp(((-0.5 * pow(((*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_28 * __pyx_v_y.strides[0]) ))) - (*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_29 * __pyx_v_y.strides[0]) )))), 2.0)) / __pyx_v_sigma_y));

        /* "independence_tests/hsic_cy.pyx":69
 *                 kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 *                 ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 *                 trace_xy += (kx_ij - kx_mean_1[i]) * (ky_ij - ky_mean_1[j])             # <<<<<<<<<<<<<<
 *         return trace_xy / (n - 1) ** 2
 ...
 */
        ...
        __pyx_v_trace_xy = (__pyx_v_trace_xy + ((__pyx_v_kx_ij - (*__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_kx_mean_1.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_kx_mean_1.diminfo[0].strides))) * (__pyx_v_ky_ij - (*__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_ky_mean_1.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_ky_mean_1.diminfo[0].strides)))));
      }
    }

    /* "independence_tests/hsic_cy.pyx":70
 *                 ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 *                 trace_xy += (kx_ij - kx_mean_1[i]) * (ky_ij - ky_mean_1[j])
 *         return trace_xy / (n - 1) ** 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_6 = PyFloat_FromDouble((__pyx_v_trace_xy / __Pyx_pow_Py_ssize_t((__pyx_v_n - 1), 2))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_r = __pyx_t_6;
    __pyx_t_6 = 0;
    goto __pyx_L0;
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":72
 *         return trace_xy / (n - 1) ** 2
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         for j in range(n):
 ...
 */
  ...
  for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
    ...
    /* "independence_tests/hsic_cy.pyx":73
 * 
 *     for i in range(n):
 *         for j in range(n):             # <<<<<<<<<<<<<<
 *             kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "independence_tests/hsic_cy.pyx":74
 *     for i in range(n):
 *         for j in range(n):
 *             kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)             # <<<<<<<<<<<<<<
 *             ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 ...
 */
      ...
      __pyx_v_kx_ij = exp(((-0.5 * pow(((*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_32 * __pyx_v_x.strides[0]) ))) - (*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_33 * __pyx_v_x.strides[0]) )))), 2.0)) / __pyx_v_sigma_x));

      /* "independence_tests/hsic_cy.pyx":75
 *         for j in range(n):
 *             kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 *             ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)             # <<<<<<<<<<<<<<
 *             trace_xy += (kx_ij - kx_mean_1[i]) * (ky_ij - ky_mean_1[j])
 ...
 */
      ...
      __pyx_v_ky_ij = exp(((-0.5 * pow(((*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_34 * __pyx_v_y.strides[0]) ))) - (*((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_35 * __pyx_v_y.strides[0]) )))), 2.0)) / __pyx_v_sigma_y));

      /* "independence_tests/hsic_cy.pyx":76
 *             kx_ij = exp(-0.5 * (x[i] - x[j]) ** 2 / sigma_x)
 *             ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 *             trace_xy += (kx_ij - kx_mean_1[i]) * (ky_ij - ky_mean_1[j])             # <<<<<<<<<<<<<<
 *             trace_xx += (kx_ij - kx_mean_1[i]) * (kx_ij - kx_mean_1[j])
 ...
 */
      ...
      __pyx_v_trace_xy = (__pyx_v_trace_xy + ((__pyx_v_kx_ij - (*__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_kx_mean_1.rcbuffer->pybuffer.buf, __pyx_t_36, __pyx_pybuffernd_kx_mean_1.diminfo[0].strides))) * (__pyx_v_ky_ij - (*__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_ky_mean_1.rcbuffer->pybuffer.buf, __pyx_t_37, __pyx_pybuffernd_ky_mean_1.diminfo[0].strides)))));

      /* "independence_tests/hsic_cy.pyx":77
 *             ky_ij = exp(-0.5 * (y[i] - y[j]) ** 2 / sigma_y)
 *             trace_xy += (kx_ij - kx_mean_1[i]) * (ky_ij - ky_mean_1[j])
 *             trace_xx += (kx_ij - kx_mean_1[i]) * (kx_ij - kx_mean_1[j])             # <<<<<<<<<<<<<<
 *             trace_yy += (ky_ij - ky_mean_1[i]) * (ky_ij - ky_mean_1[j])
 ...
 */
      ...
      __pyx_v_trace_xx = (__pyx_v_trace_xx + ((__pyx_v_kx_ij - (*__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_kx_mean_1.rcbuffer->pybuffer.buf, __pyx_t_38, __pyx_pybuffernd_kx_mean_1.diminfo[0].strides))) * (__pyx_v_kx_ij - (*__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_kx_mean_1.rcbuffer->pybuffer.buf, __pyx_t_39, __pyx_pybuffernd_kx_mean_1.diminfo[0].strides)))));

      /* "independence_tests/hsic_cy.pyx":78
 *             trace_xy += (kx_ij - kx_mean_1[i]) * (ky_ij - ky_mean_1[j])
 *             trace_xx += (kx_ij - kx_mean_1[i]) * (kx_ij - kx_mean_1[j])
 *             trace_yy += (ky_ij - ky_mean_1[i]) * (ky_ij - ky_mean_1[j])             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_trace_yy = (__pyx_v_trace_yy + ((__pyx_v_ky_ij - (*__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_ky_mean_1.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_ky_mean_1.diminfo[0].strides))) * (__pyx_v_ky_ij - (*__Pyx_BufPtrStrided1d(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *, __pyx_pybuffernd_ky_mean_1.rcbuffer->pybuffer.buf, __pyx_t_41, __pyx_pybuffernd_ky_mean_1.diminfo[0].strides)))));
    }
  }

  /* "independence_tests/hsic_cy.pyx":80
 *             trace_yy += (ky_ij - ky_mean_1[i]) * (ky_ij - ky_mean_1[j])
 * 
 *     if trace_xx * trace_yy > 0.0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "independence_tests/hsic_cy.pyx":81
 * 
 *     if trace_xx * trace_yy > 0.0:
 *         return trace_xy / (trace_xx * trace_yy) ** 0.5             # <<<<<<<<<<<<<<
 *     return 1.0
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_6 = PyFloat_FromDouble((__pyx_v_trace_xy / pow((__pyx_v_trace_xx * __pyx_v_trace_yy), ((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t)0.5)))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 81, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_r = __pyx_t_6;
    __pyx_t_6 = 0;
    goto __pyx_L0;
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":82
 *     if trace_xx * trace_yy > 0.0:
 *         return trace_xy / (trace_xx * trace_yy) ** 0.5
 *     return 1.0             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("independence_tests.hsic_cy.hsic", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_kx_mean_1.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_18independence_tests_7hsic_cy_1hsic(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_18independence_tests_7hsic_cy_hsic[] = "\n    Cython code for HSIC (with RBF kernel). \n    Equivalent result to Python version:\n\n    >>> k_x -= np.mean(k_x, axis=1)\n    >>> k_y -= np.mean(k_y, axis=1)\n    >>> \n    >>> trace_xy = np.einsum('ji,ij', k_x, k_y)\n    >>> if scale:\n    >>>     trace_xx = np.einsum('ji,ij', k_x, k_x)\n    >>>     trace_yy = np.einsum('ji,ij', k_y, k_y)\n    >>>     hsic_score = trace_xy / (trace_xx * trace_yy) ** 0.5\n    >>> else:\n    >>>     hsic_score = trace_xy / (k_x.shape[0] - 1) ** 2\n    ";
static PyObject *__pyx_pw_18independence_tests_7hsic_cy_1hsic(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_sigma_x;
  __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_sigma_y;
  int __pyx_v_scale;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("hsic (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("hsic", 0, 2, 5, 1); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "hsic") < 0)) __PYX_ERR(0, 16, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_y.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_sigma_x = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_sigma_x == ((npy_double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    } else {
      __pyx_v_sigma_x = ((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t)0.0);
    }
    if (values[3]) {
      __pyx_v_sigma_y = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_sigma_y == ((npy_double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
    } else {
      __pyx_v_sigma_y = ((__pyx_t_18independence_tests_7hsic_cy_DTYPE_t)0.0);
    }
    if (values[4]) {
      __pyx_v_scale = __Pyx_PyObject_IsTrue(values[4]); if (unlikely((__pyx_v_scale == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
    } else {
 ...
 */
  ...
  __Pyx_RaiseArgtupleInvalid("hsic", 0, 2, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("independence_tests.hsic_cy.hsic", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_18independence_tests_7hsic_cy_hsic(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_sigma_x, __pyx_v_sigma_y, __pyx_v_scale);
...
static PyObject *__pyx_pf_18independence_tests_7hsic_cy_hsic(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_sigma_x, __pyx_t_18independence_tests_7hsic_cy_DTYPE_t __pyx_v_sigma_y, int __pyx_v_scale) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_18independence_tests_7hsic_cy_hsic __pyx_t_2;
  __Pyx_RefNannySetupContext("hsic", 0);
  __Pyx_XDECREF(__pyx_r);
  ...
  __pyx_t_1 = __pyx_f_18independence_tests_7hsic_cy_hsic(__pyx_v_x, __pyx_v_y, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "independence_tests.hsic_cy.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "independence_tests.hsic_cy.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "independence_tests.hsic_cy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "independence_tests.hsic_cy._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"hsic", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_18independence_tests_7hsic_cy_1hsic, METH_VARARGS|METH_KEYWORDS, __pyx_doc_18independence_tests_7hsic_cy_hsic},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_hsic_cy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_hsic_cy},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_hsic_line_16, __pyx_k_hsic_line_16, sizeof(__pyx_k_hsic_line_16), 0, 1, 0, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC inithsic_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC inithsic_cy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_hsic_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_hsic_cy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_hsic_cy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'hsic_cy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_hsic_cy(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("hsic_cy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_independence_tests__hsic_cy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "independence_tests.hsic_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "independence_tests.hsic_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "independence_tests/hsic_cy.pyx":4
 * 
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":6
 * import numpy as np
 * cimport numpy as np
 * from scipy.spatial.distance import pdist             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":8
 * from scipy.spatial.distance import pdist
 * 
 * DTYPE = np.float_             # <<<<<<<<<<<<<<
 * ctypedef np.double_t DTYPE_t
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":11
 * ctypedef np.double_t DTYPE_t
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "independence_tests/hsic_cy.pyx":1
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_hsic_line_16, __pyx_kp_u_Cython_code_for_HSIC_with_RBF_k) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init independence_tests.hsic_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init independence_tests.hsic_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t(PyObject *obj, int writable_flag) {
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 ...
                                                 &__Pyx_TypeInfo_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t, stack,
                                                 &result, obj);
...
/* MemviewDtypeToObject */
  static CYTHON_INLINE PyObject *__pyx_memview_get_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t(const char *itemp) {
    return (PyObject *) PyFloat_FromDouble(*(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) itemp);
}
static CYTHON_INLINE int __pyx_memview_set_nn___pyx_t_18independence_tests_7hsic_cy_DTYPE_t(const char *itemp, PyObject *obj) {
    __pyx_t_18independence_tests_7hsic_cy_DTYPE_t value = __pyx_PyFloat_AsDouble(obj);
    if ((value == ((npy_double)-1)) && PyErr_Occurred())
        return 0;
    *(__pyx_t_18independence_tests_7hsic_cy_DTYPE_t *) itemp = value;
    return 1;
}
